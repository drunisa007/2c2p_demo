 ...
 */
public class CreditCardTokenization extends BasePayment {

    private final String TAG = CreditCardTokenization.class.getName();

    /**
     * Reference : https://developer.2c2p.com/docs/mobile-v4-card-tokenization
     *             https://developer.2c2p.com/docs/mobile-v4-api-parameters#credit-card-payment-builder
     */
    public CreditCardTokenization(Fragment fragment) {
        super(fragment);
    }
