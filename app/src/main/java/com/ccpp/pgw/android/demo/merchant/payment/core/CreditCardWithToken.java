 ...
 */
public class CreditCardWithToken extends BasePayment {

    private final String TAG = CreditCardWithToken.class.getName();

    /**
     *  Reference : https://developer.2c2p.com/docs/mobile-v4-payment-with-card-token
     *              https://developer.2c2p.com/docs/mobile-v4-api-parameters#card-token-payment-builder
     */
    public CreditCardWithToken(Fragment fragment) {
        super(fragment);
    }
    ...
    void submit(String paymentToken) {
        ...
        //Step 2: Set card token
        String cardToken = "11101811034671355116";

        //Step 3: Construct credit card request.
        CreditCardPayment cardTokenPayment = new CardTokenPaymentBuilder(cardToken)
                .setSecurityCode("123")
                .build();

        //Step 4: Construct transaction request.
        TransactionRequest transactionRequest = new TransactionRequestBuilder(paymentToken)
                .withCreditCardPayment(cardTokenPayment)
                .build();
